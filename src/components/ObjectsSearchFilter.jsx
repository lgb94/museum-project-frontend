  ...
  return (
    <div className="filters-box">
      <div className="filter-option">
        ...
        {filters.title && (
          <>
            ...
            <button onClick={handleResetTitleFilter}>Reset Title Filter</button>
          </>
        )}
      </div>
      <div className="filter-option">
      ...
      <div className="filter-option">
        ...
        {filters.medium && (
          <>
            <p>current medium filter: {filters.medium.replace(/^%|%$/g, "")}</p>
      ...
      <div className="filter-option">
        ...
        {filters.period && (
          <>
            <p>current period filter: {filters.period.replace(/^%|%$/g, "")}</p>
      ...
      <div className="filter-option">
        ...
        {filters.object_end_date && (
          <>
            <p>
              current object end date filter: {filters.object_end_date_operator}{" "}
              {filters.object_end_date}
            </p>
